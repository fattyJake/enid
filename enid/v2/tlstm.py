...
class TLSTM(Layer):
    ...
    def build(self, input_shape):
        ...
        self.bi = self.add_weight(
            name='Input_Hidden_bias', shape=[
                self.units, ], initializer='he_normal')
        ...
        self.Uf = self.add_weight(
            name='Forget_State_weight', shape=[
                self.units, self.units], initializer='he_normal')
        self.bf = self.add_weight(
            name='Forget_Hidden_bias', shape=[
                self.units, ], initializer='he_normal')
        ...
        self.Uo = self.add_weight(
            name='Output_State_weight', shape=[
                self.units, self.units], initializer='he_normal')
        self.bo = self.add_weight(
            name='Output_Hidden_bias', shape=[
                self.units, ], initializer='he_normal')
        ...
        self.bc = self.add_weight(
            name='Cell_Hidden_bias', shape=[
                self.units, ], initializer='he_normal')

        self.W_decomp = self.add_weight(
            name='Decomposition_Hidden_weight', shape=[
                self.units, self.units], initializer='he_normal')
        self.b_decomp = self.add_weight(
            name='Decomposition_Hidden_bias_enc', shape=[
                self.units, ], initializer='he_normal')
    ...
    def call(self, inputs):
        ...
        scan_input = array_ops.transpose(inputs, perm=[1, 0, 2])
