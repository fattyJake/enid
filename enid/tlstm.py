...
class TLSTMCell(rnn_cell_impl.RNNCell):
        ...
        with vs.variable_scope(scope or "linear"):
            ...
            if bias:
                b = vs.get_variable("bias",
                                    initializer=[0.0] * weight_shape[-1])
    ...
    def call(self, inputs, state):
        ...
        state: LSTMStateTuple
            ...
            `[batch_size x self.state_size]`, if `state_is_tuple` has been set
            to `True`.  Otherwise, a `Tensor` shaped
        ...
        if self._time_aware:
            ...
            C_ST = gen_math_ops.tanh(self._linear(
                c,
